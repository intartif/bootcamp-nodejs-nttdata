...
(function () {
    ...
    var ingresaNumero = function (ingreso) {
        return new Promise(function (resolve, reject) {
            ...
            var numAlertario = Math.floor(Math.random() * 5 + 1);
            if (isNaN(numNuevo)) {
    ...
    var continuarAdivanza = function (terminar) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    console.log("El resultado del numero aleatorio es: ".concat(aleatorio, " y obtuviste ").concat(puntos, "pts"));
                    return [4 /*yield*/, continuarAdivanza(status)];
                case 2:
                    continuar = _a.sent();
                    if (continuar) {
